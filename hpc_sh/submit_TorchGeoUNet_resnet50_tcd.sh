...
#SBATCH --job-name=lwf_TorchGeoUNet_resnet50_tcd
...
uv run train_lwf --config /dss/dsshome1/02/di54xen/projects/oma24-proj/config/TorchGeoUNet/lwf_TorchGeoUNet_resnet50_tcd.yaml
