...
#SBATCH --job-name=lwf_TorchGeoUNet_baseline_1
...
uv run train_lwf --config /dss/dsshome1/02/di54xen/projects/oma24-proj/config/TorchGeoUNet/lwf_TorchGeoUNet_baseline.yaml
